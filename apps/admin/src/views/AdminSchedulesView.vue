...
.empty-glyph { font-family: var(--mono); font-size: 48px; color: var(--brand); opacity: 0.5; margin-bottom: 14px; }
.empty-big { font-family: var(--frau); font-size: 22px; color: var(--ink-2); }
